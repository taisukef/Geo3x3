...
112 languages supported ([langlist.csv](langlist.csv) / [langlist.html](https://taisukef.github.io/Geo3x3/langlist.html))  
...
to run:
```bash
python sui-lang/sui.py geo3x3_encode.sui 35.65858 139.745433 14
python sui-lang/sui.py geo3x3_decode.sui E9139659937288
```
